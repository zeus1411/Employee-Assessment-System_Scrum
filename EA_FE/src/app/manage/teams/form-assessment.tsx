...
//   // Cập nhật currentDate theo thời gian hiện tại (11:33 AM +07 on Thursday, June 19, 2025)
//   const currentDate = new Date("2025-06-19T11:33:00+07:00");
...
//       });
//       onSubmitSuccess?.();
//       // Không chuyển hướng, để dialog tự xử lý đóng
//     } catch (error) {
//       toast({
//         title: "Error",
...
const FormAssessment: React.FC<FormAssessmentProps> = ({
  ...
  // Cập nhật currentDate theo thời gian hiện tại (11:53 AM +07 on Thursday, June 19, 2025)
  const currentDate = new Date("2025-06-19T11:53:00+07:00");
